                ...
                <div class="p-6">
                    <form action="{{ route('admin.educations.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="institution" value="{{ old('institution') }}" required placeholder="e.g., Universitas Indonesia" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                            @error('institution')<span class="text-red-500 text-sm">{{ $message }}</span>@enderror
                        </div>

                        <div class="mb-4">
                            <label class="block text-gray-700 mb-2">Degree *</label>
                            <input type="text" name="degree" value="{{ old('degree') }}" required placeholder="e.g., Bachelor's Degree, Master's Degree" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="field" value="{{ old('field') }}" required placeholder="e.g., Computer Science" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
