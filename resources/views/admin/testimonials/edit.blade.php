                ...
                <div class="p-6">
                    <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="client_name" value="{{ old('client_name', $testimonial->client_name) }}" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="client_position" value="{{ old('client_position', $testimonial->client_position) }}" required placeholder="e.g., CEO, Product Manager" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="client_company" value="{{ old('client_company', $testimonial->client_company) }}" placeholder="e.g., Tech Company Inc." class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
                        ...
                        <div class="mb-4">
                            ...
                            <img src="{{ asset('storage/' . $testimonial->client_image) }}" alt="{{ $testimonial->client_name }}" class="w-20 h-20 object-cover mb-2 rounded-full">
                            @endif
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="testimonial" rows="5" required placeholder="Write the testimonial here..." class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">{{ old('testimonial', $testimonial->testimonial) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="order" value="{{ old('order', $testimonial->order) }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">
